...
export default function Button({ children, className, onClick }: ButtonProps) {
	return (
		<button className={`max-w-full  ${className}`} onClick={onClick}>
			<div className='group max-w-full relative p-0.5 bg-gradient-to-b from-[#2B1853] to-[#391E73] rounded-[10px] shadow-[inset_0px_-3px_10.899999618530273px_0px_rgba(72,38,145,0.67)] border border-[#8769de] border-opacity-30 flex-col justify-start items-start gap-2.5 flex active:scale-95 transition-all duration-200 ease-in-out cursor-pointer overflow-hidden animate-pulse-subtle'>
