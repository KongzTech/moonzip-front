...
export default function Highlight() {
    ...
    return (
        <div className='w-full flex flex-col items-center relative pb-2 lg:pb-6 justify-center'>
            <RetroGrid className=''/>
            <div
                className='mt-5 lg:mt-8 w-full justify-between font-ibm-mono text-sm font-semibold items-start inline-flex'>
            ...
            <div
                className='px-0 lg:px-4 relative w-full mt-8 lg:mt-5 justify-start items-center lg:items-start gap-7 flex flex-col lg:flex-row'>
                <img
                ...
                <div
                    className='absolute top-16 lg:top-20 lg:left-12 max-w-fit right-1/2 translate-x-1/2 lg:right-0 lg:translate-x-0 flex bg-gradient-to-b from-[#8769de]/30 to-[#8769de]/0 p-[1px] rounded-[32px]'>
                    <div
                        className='h-8 px-2.5 py-1 bg-gradient-to-b from-[#28174d] to-[#351c69] rounded-[31px] icn-white justify-start items-center gap-1 inline-flex'>
                        <BadgeIcon/>
                ...
                <div
                    className='self-stretch mt-2 lg:mt-0 flex-col lg:flex-row flex-1 lg:items-center items-center  gap-4 flex'>
                    <div
                        className='grow shrink basis-0 flex-col justify-start items-center lg:items-start gap-2 inline-flex'>
                    ...
                    <div
                        className='lg:self-stretch justify-start mt-1 lg:mt-0 items-start lg:items-end gap-3 flex flex-row-reverse lg:flex-row'>
